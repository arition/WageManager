...
{
    class WorkSheet_Individual_Wage_YH
    {
        public static void Create(Worksheet ws, List<Wage> WageList)
        {
            ...
            foreach (Wage wage in WageList.Where((s) => s.company.公司名.Contains("优弧")))
            {
                ...
                range = ws.get_Range("B" + currentRow, "M" + currentRow);
                range.Merge(false);
                range.HorizontalAlignment = XlHAlign.xlHAlignCenter;
                ws.Cells[currentRow, 2] = "应发工资";
                range = ws.get_Range("N" + currentRow, DeductionEnd_str + currentRow);
                range.Merge(false);
                range.HorizontalAlignment = XlHAlign.xlHAlignCenter;
                ws.Cells[currentRow, 14] = "代扣费用";
                ...
                ws.Cells[currentRow, currentColumn] = "饭贴"; currentColumn++;
                ws.Cells[currentRow, currentColumn] = "房帖"; currentColumn++;
                ...
                ws.Cells[currentRow, currentColumn] = wage.mealBonus; currentColumn++;
                ws.Cells[currentRow, currentColumn] = wage.houseBonus; currentColumn++;
                ws.Cells[currentRow, currentColumn] = wage.adjustmentSalary; currentColumn++;
                ws.Cells[currentRow, currentColumn] = "=SUM(B" + currentRow + ":L" + currentRow + ")"; currentColumn++;
                ...
                ws.Cells[currentRow, currentColumn] = "=SUM(B" + currentRow + ":L" + currentRow + ")-SUM(N" + currentRow + ":" + DeductionEnd_str + currentRow + ")"; currentColumn++;
